        ...
        <nav className="nav-menu">
            <ul className="nav-menu__list">
                <li className="nav-menu__links nav-menu__links_gap">
                    <a href="#" className="nav-menu__link nav-menu__link_size">Фильмы</a>
                    <a href="#" className="nav-menu__link nav-menu__link_size">Сохраненные фильмы</a>
                </li>
                ...
                {/*</li>*/}
                <li className="nav-menu__links nav-menu__links_gap">
                    <a href="#" className="nav-menu__link nav-menu__link_profile">Аккаунт</a>
